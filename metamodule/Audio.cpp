...
void Audio::ChannelProcess1(rainbow::IO &io, std::span<rack::engine::Input> input, std::span<rack::engine::Output> output, rainbow::FilterBank &filterbank) {
...
void Audio::ChannelProcess2(rainbow::IO &io, std::span<rack::engine::Input> input, std::span<rack::engine::Output> output, rainbow::FilterBank &filterbank) {
